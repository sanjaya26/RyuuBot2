...
footer: fot,
text: 'Made By Yuu ',
mentions: await conn.parseMention(yuu),
title: yuu,
buttonText: `CLICK HERE ⎙`, 
sections
}
if (teks == '404') {
return conn.sendMessage(m.chat, listMessage, { quoted: fkontak, mentions: await conn.parseMention(yuu), contextInfo:{ forwardingScore: 99999, isForwarded: true }}) 
}     
    let groups = {}
    for (let tag in tags) {
      groups[tag] = []
 ...
 const fcon = {
    ...
    //------------------ DOCUMENT
let gh = 'https://github.com/yuu?tab=repositories'
let buttonMessage= {
'document':{'url':gh},
...
'mediaUrl': 'https://instagram.com/yuuchnz',
'title': 'Yuu',
'body':'',
'mediaType': 2,
'thumbnail': fs.readFileSync('./thumbnail.jpg'),
'sourceUrl': 'https://instagram.com/yuuchnz'}},
...
'headerType':6}
    ...
    conn.sendFile(m.chat, './mp3/yuu.mp3', '', null, m, true, { type: "audioMessage", ptt: true, fileLength: 88738 })
  } catch (e) {
