...
let handler = async (m, { conn, text }) => {
    ...
    if (money > 100000000000000000000000000000000000) return m.reply(`Maks 10000000000000000000000000000000000000000000`) 
    if (money < 1000) return m.reply('Minimal 1000') 
    if (money < 10000000000000000000000000000000000000001) {
    users[who].money += poin
